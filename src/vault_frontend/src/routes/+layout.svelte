<script lang="ts">
  ...
  // Reactive current path from SvelteKit page store — fixes nav highlight bug
...
<aside class="sidebar">
  <div class="sidebar-inner">
    ...
    <a href="/" class="sidebar-brand">
      <img src="/rumi-header-logo.png" alt="Rumi" class="sidebar-logo" />
      <span class="sidebar-brand-name">RUMI</span>
    </a>
    ...
    <nav class="sidebar-nav">
      ...
      {#if isConnected && canViewVaults}
        <a href="/vaults" class="nav-link" class:active={currentPath.startsWith('/vaults')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <a href="/liquidations" class="nav-link" class:active={currentPath === '/liquidations'}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <a href="/stability-pool" class="nav-link" class:active={currentPath === '/stability-pool'}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      {#if isConnected && $permissionStore.isDeveloper}
        <a href="/treasury" class="nav-link" class:active={currentPath === '/treasury'}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <a href="/learn-more" class="nav-link" class:active={currentPath === '/learn-more'}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
...
<header class="top-header">
  ...
  <div class="header-right">
    <div class="header-links">
      <a href="mailto:team@rumiprotocol.io" class="header-icon-link" aria-label="Email">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <a href="https://github.com/RumiLabsXYZ/rumi-protocol-v2" target="_blank" rel="noopener noreferrer" class="header-icon-link" aria-label="GitHub">
        <svg viewBox="0 0 24 24" fill="currentColor">
...
<nav class="mobile-nav">
  <a href="/" class="mobile-nav-item" class:active={currentPath === '/'}>
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>
      <polyline points="9,22 9,12 15,12 15,22"/>
    </svg>
  ...
  {#if isConnected && canViewVaults}
    <a href="/vaults" class="mobile-nav-item" class:active={currentPath.startsWith('/vaults')}>
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        <rect x="3" y="11" width="18" height="11" rx="2" ry="2"/>
        <path d="M7 11V7a5 5 0 0 1 10 0v4"/>
      </svg>
  ...
  {/if}
  <a href="/liquidations" class="mobile-nav-item" class:active={currentPath === '/liquidations'}>
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      <line x1="12" y1="1" x2="12" y2="23"/>
      <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>
    </svg>
  ...
  <a href="/stability-pool" class="mobile-nav-item" class:active={currentPath === '/stability-pool'}>
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      <circle cx="12" cy="12" r="10"/>
      <path d="M12 6v6l4 2"/>
    </svg>
...
<style>
  /* ============================================
     Sidebar — always shows icon + label
     ============================================ */
  .sidebar {
    position: fixed;
    top: 0;
    ...
    width: 180px;
    height: 100vh;
    background: var(--rumi-bg-secondary);
