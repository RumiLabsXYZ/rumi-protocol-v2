...
<style>
  ...
  .nav-link:hover { color:var(--rumi-text-primary);background:rgba(124,58,237,0.06); }
  ...
  .header-icon-link:hover { color:var(--rumi-text-primary);background:rgba(124,58,237,0.08); }
