    ...
    <table class="w-full text-sm">
      <thead>
        <tr class="border-b border-white/5">
          ...
          <th class="text-right py-2 px-2 text-xs font-medium text-gray-500 uppercase tracking-wider" title="Currently open vaults using this collateral">Open Vaults</th>
        ...
        {#each rows as row}
          <tr class="border-b border-white/[0.03] hover:bg-white/[0.02] transition-colors">
            <td class="py-2.5 px-2">
              <a href="/explorer/e/token/{row.principal}" class="flex items-center gap-2 hover:text-teal-300 transition-colors">
