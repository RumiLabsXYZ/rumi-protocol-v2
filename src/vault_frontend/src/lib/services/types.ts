...
export interface CollateralInfo {
  ...
  custodyKind?: 'IcrcLedger' | 'NativeXrp' | 'NativeSol'; // How the collateral is custodied; NativeXrp/NativeSol = off-chain XRPL/Solana via threshold Ed25519 (no real ICRC ledger)
}
