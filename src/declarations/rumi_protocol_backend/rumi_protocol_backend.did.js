export const idlFactory = ({ IDL }) => {
  ...
  const Result_23 = IDL.Variant({ 'Ok' : IDL.Nat32, 'Err' : ProtocolError });
  return IDL.Service({
    ...
    'repay_and_close_vault' : IDL.Func([VaultArg], [Result_17], []),
    ...
    'submit_burn_proof' : IDL.Func([IDL.Nat32, IDL.Text], [Result_23], []),
