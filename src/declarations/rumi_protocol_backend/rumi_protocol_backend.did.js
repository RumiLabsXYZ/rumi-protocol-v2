export const idlFactory = ({ IDL }) => {
  ...
  const NativeClaimResolution = IDL.Variant({
  ...
  const ChainStatus = IDL.Variant({
    'Disabled' : IDL.Null,
    'Registered' : IDL.Null,
  });
  const ChainPublicLaunchStatus = IDL.Record({
    'status' : IDL.Opt(ChainStatus),
    'chains_ecdsa_key_matches_expected' : IDL.Bool,
    'liquidation_configured' : IDL.Bool,
    'expected_liquidation_config_digest' : IDL.Text,
    'chain_supply_e8s' : IDL.Nat,
    'hot_wallet_balance_e18' : IDL.Opt(IDL.Nat),
    'liquidation_config_matches_expected' : IDL.Bool,
    'hot_wallet_min_balance_e18' : IDL.Nat,
    'icusd_contract_matches_expected' : IDL.Bool,
    'rpc_endpoint_count' : IDL.Nat32,
    'rpc_min_quorum_providers' : IDL.Nat32,
    'rpc_effective_agreement_requirement' : IDL.Nat32,
    'bad_debt_threshold_e8s' : IDL.Opt(IDL.Nat),
    'finality_depth' : IDL.Opt(IDL.Nat32),
    'native_symbol' : IDL.Opt(IDL.Text),
    'public_open_ready' : IDL.Bool,
    'max_price_age_ns' : IDL.Opt(IDL.Nat64),
    'liquidation_config_digest' : IDL.Opt(IDL.Text),
    'bad_debt_e8s' : IDL.Nat,
    'collateral_price_age_ns' : IDL.Opt(IDL.Nat64),
    'effective_debt_config' : IDL.Opt(ChainDebtConfigV1),
    'hot_wallet_balance_is_fresh' : IDL.Bool,
    'burn_cursor' : IDL.Nat64,
    'debt_config_matches_expected' : IDL.Bool,
    'hot_wallet_ready' : IDL.Opt(IDL.Bool),
    'min_cr_e4' : IDL.Opt(IDL.Nat64),
    'chains_ecdsa_key_name' : IDL.Text,
    'liquidation_enabled' : IDL.Bool,
    'hot_wallet_balance_refreshed_at_ns' : IDL.Opt(IDL.Nat64),
    'bound_icusd_contract' : IDL.Opt(IDL.Text),
    'chain_id' : IDL.Nat32,
    'collateral_config_matches_expected' : IDL.Bool,
    'configured' : IDL.Bool,
    'chain_reserve_backing_e8s' : IDL.Nat,
    'invariant_halted' : IDL.Bool,
    'protocol_mode' : Mode,
    'reorg_halted' : IDL.Bool,
    'blocking_reasons' : IDL.Vec(IDL.Text),
    'bad_debt_circuit_tripped' : IDL.Bool,
    'rpc_configuration_sufficient' : IDL.Bool,
    'liquidation_threshold_e4' : IDL.Opt(IDL.Nat64),
    'collateral_price_e8' : IDL.Opt(IDL.Nat64),
    'hot_wallet_balance_max_age_ns' : IDL.Nat64,
    'evm_rpc_principal_matches_expected' : IDL.Bool,
    'collateral_price_is_fresh' : IDL.Bool,
    'bad_debt_tripped_at_ns' : IDL.Opt(IDL.Nat64),
    'collateral_price_set_at_ns' : IDL.Opt(IDL.Nat64),
    'effective_evm_rpc_principal' : IDL.Principal,
    'chain_pending_burn_e8s' : IDL.Nat,
    'hot_wallet_balance_age_ns' : IDL.Opt(IDL.Nat64),
    'protocol_frozen' : IDL.Bool,
    'registered' : IDL.Bool,
  });
  ...
  const ChainRpcEndpointSetDigestV1 = IDL.Record({
    'digest_sha256' : IDL.Text,
    'effective_min_quorum_providers' : IDL.Nat32,
    'endpoint_count' : IDL.Nat32,
    'chain_id' : IDL.Nat32,
  });
  const ChainRpcEndpointDigestError = IDL.Variant({
  ...
  const SolSettlement = IDL.Record({
    'destination' : IDL.Text,
    'signature' : IDL.Text,
    'nonce_value' : IDL.Text,
    'submitted_at_ns' : IDL.Nat64,
  });
  const SolClaim = IDL.Record({
    ...
    'settlement' : IDL.Opt(SolSettlement),
  });
  const SolPendingDeposit = IDL.Record({
    'owner' : IDL.Principal,
    'custody_address' : IDL.Text,
    'rent_exempt_lamports' : IDL.Nat64,
    'opened_at_ns' : IDL.Nat64,
  ...
  const Result_9 = IDL.Variant({ 'Ok' : IDL.Nat8, 'Err' : ProtocolError });
  ...
  const Result_10 = IDL.Variant({ 'Ok' : IDL.Float64, 'Err' : ProtocolError });
  ...
  const Result_11 = IDL.Variant({ 'Ok' : ConsentInfo, 'Err' : Icrc21Error });
  ...
  const ChainVaultPage = IDL.Record({
    'done' : IDL.Bool,
    'vaults' : IDL.Vec(ChainVaultV1),
    'scanned_count' : IDL.Nat16,
    'next_start_after' : IDL.Opt(IDL.Nat64),
  });
  const SolVaultOpenInfo = IDL.Record({
    'custody_address' : IDL.Text,
    'rent_exempt_lamports' : IDL.Nat64,
    'vault_id' : IDL.Nat64,
  });
  ...
  const ChainHotWalletBalanceRefresh = IDL.Record({
  ...
  return IDL.Service({
    ...
    'admin_quarantine_sol_claim' : IDL.Func(
        [IDL.Nat64, IDL.Text],
        [Result],
        [],
      ),
    ...
    'admin_resolve_sol_claim' : IDL.Func(
        [IDL.Nat64, NativeClaimResolution],
        [Result],
        [],
      ),
    ...
    'cancel_sol_pending_open' : IDL.Func([IDL.Nat64], [Result], []),
    ...
    'confirm_sol_deposit' : IDL.Func([IDL.Nat64], [Result_1], []),
    ...
    'get_chain_public_launch_status' : IDL.Func(
        [IDL.Nat32],
    ...
    'get_my_sol_claims' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(IDL.Nat64, SolClaim))],
        ['query'],
      ),
    'get_my_sol_pending_deposits' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(IDL.Nat64, SolPendingDeposit))],
        ['query'],
      ),
    ...
    'get_redemption_tier' : IDL.Func([IDL.Principal], [Result_9], ['query']),
    ...
    'get_sol_claims' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(IDL.Nat64, SolClaim))],
        ['query'],
      ),
    'get_sol_pending_deposits' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(IDL.Nat64, SolPendingDeposit))],
        ['query'],
      ),
    'get_sol_quarantined_claims' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(IDL.Nat64, SolClaim))],
        ['query'],
      ),
    'get_sol_schnorr_key_name' : IDL.Func([], [IDL.Text], ['query']),
    ...
    'get_vault_interest_rate' : IDL.Func([IDL.Nat64], [Result_10], ['query']),
    'get_vaults' : IDL.Func(
        [IDL.Opt(IDL.Principal)],
        [IDL.Vec(CandidVault)],
        ['query'],
    ...
    'open_sol_vault' : IDL.Func([], [Result_12], []),
    ...
    'refresh_chain_hot_wallet_balance' : IDL.Func([IDL.Nat32], [Result_19], []),
    'register_chain' : IDL.Func([RegisterChainArg], [Result], []),
    'register_sol_collateral' : IDL.Func([], [Result], []),
    'register_xrp_collateral' : IDL.Func([], [Result], []),
    'repay_and_close_vault' : IDL.Func([VaultArg], [Result_20], []),
    ...
    'set_sol_schnorr_key_name' : IDL.Func([IDL.Text], [Result], []),
    ...
    'settle_sol_claim' : IDL.Func([IDL.Nat64, IDL.Text], [Result_2], []),
    ...
    'sol_balance' : IDL.Func([IDL.Text], [Result_1], []),
    'sol_bootstrap_nonce_account' : IDL.Func(
        [IDL.Opt(IDL.Text)],
        [Result_2],
        [],
      ),
    'sol_custody_address' : IDL.Func(
        [IDL.Principal, IDL.Nat64],
        [Result_2],
        [],
      ),
    'sol_settlement_address' : IDL.Func([], [Result_2], []),
    ...
    'stability_pool_release_sol_absorb_preflight' : IDL.Func(
        [IDL.Nat64, IDL.Nat64],
        [Result_17],
        [],
      ),
