...
| CS-21 | Doing | Luna fallback implementer | Authenticated operator telemetry UI | CS-13 | Backend contract and generated declarations accepted; write-capable Sonnet unavailable |
