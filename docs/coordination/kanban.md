...
| CS-20 | Doing | Sonnet implementer | Public root-domain telemetry UI | CS-13 | Backend contract and generated declarations accepted; first-party Sonnet authentication verified outside sandbox |
| CS-21 | Ready | Unassigned | Authenticated operator telemetry UI | CS-13 | Backend contract and generated declarations accepted |
