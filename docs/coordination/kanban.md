...
| CS-20 | Doing | Luna fallback implementer | Public root-domain telemetry UI | CS-13 | Backend contract and generated declarations accepted; Sonnet runner unavailable in coordinator context |
